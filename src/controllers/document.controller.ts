...
export default class DocumentController {
  static uploadDocument = [
    ...
    catchAsync(async (req: AuthRequestWithFile, res: Response) => {
      ...
      console.log(`DocumentController: Uploading ${documentType}`);
  ...
  static getDocuments = catchAsync(async (req: AuthRequest, res: Response) => {
    ...
    const documents = await DocumentService.getAllDocumentsByOrganization(
      organizationId
    );
  ...
  static getDocumentById = catchAsync(
    async (req: AuthRequest, res: Response) => {
      ...
      console.log(`DocumentController: Getting ${type} document by ID: ${id}`);
  ...
  static deleteDocument = catchAsync(
    async (req: AuthRequest, res: Response) => {
      ...
      console.log(`DocumentController: Deleting ${type} document by ID: ${id}`);
  ...
  static updateStatus = catchAsync(async (req: AuthRequest, res: Response) => {
    ...
    console.log(
      `DocumentController: Updating ${type} status to ${status} for ID: ${id}`
    );
    ...
    try {
      ...
      console.error("Error in DocumentController.updateStatus:", error);
      res.status(500).json({
        success: false,
  ...
  static updateDocumentData = catchAsync(
    async (req: AuthRequest, res: Response) => {
      ...
      console.log(
        `DocumentController: Updating document data for ID: ${id}, Type: ${type}`
      );
      ...
      try {
        ...
        console.log(
          `DocumentController: Successfully updated ${type} data for ID: ${id}`
        );
        ...
        console.error("Error in DocumentController.updateDocumentData:", error);
        res.status(500).json({
          success: false,
  ...
  static exportDocuments = catchAsync(
    async (req: AuthRequest, res: Response) => {
      ...
      console.log(
        `DocumentController: Exporting documents for IDs: ${documentIds.join(
          ", "
        )} for organization: ${organizationCode}`
      );
      ...
      try {
        ...
        console.error("Error in DocumentController.exportDocuments:", error);
        res.status(500).json({
          success: false,
  ...
  static reScanDocument = catchAsync(
    async (req: AuthRequest, res: Response) => {
      ...
      console.log(`DocumentController: Re-scanning ${type} document ID: ${id}`);
      ...
      try {
        ...
        console.error("Error in DocumentController.reScanDocument:", error);
        res.status(500).json({
          success: false,
  ...
  static checkDocumentDuplicates = catchAsync(
    async (req: AuthRequest, res: Response) => {
      ...
      console.log(
        `DocumentController: Checking duplicates for ${type} document ID: ${id}`
      );
      ...
      try {
        ...
        console.error(
          "Error in DocumentController.checkDocumentDuplicates:",
          error
        );
        res.status(500).json({
          success: false,
